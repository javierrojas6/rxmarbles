...
exports.calculateNotificationContentHash = calculateNotificationContentHash;
exports.calculateNotificationHash = calculateNotificationHash;
...
function calculateNotificationContentHash(content) {
  ...
  if (typeof content === "string") {
    return content.split("").map(x => x.charCodeAt(0)).reduce((x, y) => x * SMALL_PRIME_1 + y * SMALL_PRIME_2);
