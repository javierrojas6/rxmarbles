...
export function renderOperatorBox(label) {
  ...
  return div('.operatorBox', {
    style
  }, [renderElevation2Before(), renderOperatorLabel(label), renderElevation2After()]);
}
//# sourceMappingURL=operator-label.js.map