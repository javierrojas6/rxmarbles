...
export const combinationExamples = {
  combineLatest: {
    ...
    apply: function (inputs) {
      return Observable.combineLatest(inputs[0], inputs[1], (x, y) => '' + x.content + y.content);
    }
  },
  concat: {
    label: 'concat',
  ...
  zip: {
    ...
    apply: function (inputs) {
      return Observable.zip(inputs[0], inputs[1], (x, y) => '' + x.content + y.content);
    }
  }
};
//# sourceMappingURL=combination-examples.js.map