...
exports.filteringExamples = undefined;

var _rxjs = require("rxjs");

/* t = time, c = content */
const filteringExamples = exports.filteringExamples = {
  debounceTime: {
  ...
  debounce: {
    ...
    apply: function (inputs, scheduler) {
      return inputs[0].debounce(x => _rxjs.Observable.timer(Number(x.content) * 10, 1000, scheduler));
    }
  },
  distinct: {
    label: 'distinct',
  ...
  throttle: {
    ...
    apply: function (inputs, scheduler) {
      return inputs[0].throttle(x => _rxjs.Observable.timer(Number(x.content) * 10, 1000, scheduler));
    }
  },
  throttleTime: {
...
//# sourceMappingURL=filtering-examples.js.map